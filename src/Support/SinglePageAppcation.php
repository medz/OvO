...
namespace Medz\Fans\Support;

use RuntimeException;
use Medz\Fans\Contracts\Applicable as ApplicableContract;
...
class SinglePageAppcation
{
     ...
     *
     * @param string $name
     * @param string $applicable instance of "\Medz\Fans\Contracts\Applicable".
     * @return void
     * @author Seven Du <shiweidu@outlook.com>
     */
    ...
    /**
     * Get "Medz\Fans\Contracts\Applicable" instance.
     *
     * @param string $spa
     * @return \Medz\Fans\Contracts\Applicable
     * @author Seven Du <shiweidu@outlook.com>
     */
