...
CREATE TABLE `pw_acloud_apis` (
  ...
  `template` text,
  `argument` varchar(255) NULL DEFAULT '',
  `argument_type` varchar(255) NULL DEFAULT '',
...
CREATE TABLE `pw_acloud_keys` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `key1` char(128) NULL DEFAULT '',
  `key2` char(128) NULL DEFAULT '',
  `key3` char(128) NULL DEFAULT '',
  `key4` char(128) NULL DEFAULT '',
  `key5` char(128) NULL DEFAULT '',
  `key6` char(128) NULL DEFAULT '',
  `created_time` int(10) unsigned NULL DEFAULT '0',
  `modified_time` int(10) unsigned NULL DEFAULT '0',
  PRIMARY KEY (`id`)
