...
class PwCache
{
    ...
    public function __construct()
    {
        ...
        if (Wekit::V('mem.isopen') && class_exists(Wekit::V('mem.server'))) {
            $this->_cacheOpen |= self::USE_MEN;
        }
        if (Wekit::V('redis.isopen') && class_exists('Redis')) {
            $this->_cacheOpen |= self::USE_REDIS;
        }
    }
