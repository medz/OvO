...
class GifMerge
{
    ...
    public $first = true;
    public $debug = false;
    public $use_loop = false;
    public $transparent = false;
    public $use_global_in = false;
    public $x = 0;
    public $y = 0;
    public $ch = 0;
    public $fin = 0;
    ...
    public $trans3 = 255;
    public $disposal = 2;
    public $out_color_table_size = 0;
    public $local_color_table_flag = 0;
    ...
    private function start_gifmerge_process($fp)
    {
        ...
        for ($loop = true; $loop;) {
            ...
            switch ($this->buffer[0]) {
                ...
                default:
                    if ($this->debug) {
                        printf("Unrecognized byte code 0x%x, truncating file!\n<br>", $this->buffer[0]);
                    }
                        $loop = false;
            }
        }
