...
class PwZip
{
    ...
    public function _readLocalFileHeaderAndData($centralDirectoryData)
    {
        ...
        if (crc32($data) != $localFileHeaderData['crc'] || strlen($data) != $localFileHeaderData['uncompressedsize']) {
            return false;
        } //crc32 校验不一致或长度不一致
        return $data;
    }
    ...
    public function _readCentralDirectoryData()
    {
        ...
        if ($centralDirectorySignature['signature'] != 0x02014b50) {
            return false;
        }
