...
class PwAttentionDao extends PwBaseDao
{
    ...
    protected $_dataStruct = ['uid', 'touid', 'created_time'];
    ...
    public function getFollowToFollow($uid, $touid, $limit)
    {
        ...
        return $smt->queryAll([$uid, $touid], 'touid');
    }
